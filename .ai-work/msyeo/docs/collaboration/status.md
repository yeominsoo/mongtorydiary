...
| --- | --- | --- | --- | --- |
| PM | 대기 | REQ-20260428-36 | `.ai-work/msyeo/docs/`, 협업 문서 | 위젯/딥링크 구현 요청 분해는 BE 요약 API 결과 이후 진행 |
| QA | 대기 | REQ-20260428-35 | API 문서, 테스트 시나리오, `mobile-flutter/test` | MVP 릴리스 회귀 체크리스트 작성 대기 |
| FE 개발자 | 대기 | REQ-20260428-33 | `mobile-flutter/lib`, `mobile-flutter/test` | 일기 작성 UX 잔여 개선 대기 |
| BE 개발자 | 대기 | REQ-20260428-34 | `src/main/java`, `src/test/java`, `src/main/resources` | 오늘/위젯 요약 API 1차 구현 대기 |
...
| REQ-20260428-33 | P1 | 일기 작성 UX 잔여 개선 | FE | 대기 | REQ-28 완료, FE 감정 선택 UI 확인 | 사진 URL 목록, 저장/이탈 UX, 날짜 선택 회귀 확인 |
| REQ-20260428-34 | P1 | 오늘/위젯 요약 API 1차 구현 | BE | 대기 | REQ-27 완료, REQ-22 완료 | today-summary API 구현과 테스트 |
| REQ-20260428-35 | P1 | MVP 릴리스 회귀 체크리스트와 신규 개선 검증 계획 | QA | 대기 | REQ-24, REQ-29, REQ-30 완료 | 자동화/수동 검증 범위 분류 |
| REQ-20260428-36 | P1 | 위젯/딥링크 구현 요청 분해와 우선순위 결정 | PM | 대기 | REQ-34 결과 확인 | FE/BE/QA 구현 요청 분리 |
...
| `src/main/java`, `src/test/java`, `src/main/resources` | BE | BE 우선 | REQ-20260428-34 오늘/위젯 요약 API 구현 |
...
- REQ-20260428-36: 위젯/딥링크 구현 요청 분해와 우선순위 결정 대기
...
- REQ-20260428-33: 일기 작성 UX 잔여 개선 대기
...
- REQ-20260428-34: 오늘/위젯 요약 API 1차 구현 대기
...
## 다음 우선 후보
1. FE: `REQ-20260428-33` 일기 작성 UX 잔여 개선
2. BE: `REQ-20260428-34` 오늘/위젯 요약 API 1차 구현
3. QA: `REQ-20260428-35` MVP 릴리스 회귀 체크리스트와 신규 개선 검증 계획
4. PM: `REQ-20260428-36` 위젯/딥링크 구현 요청 분해
...
- 다음 PM 확인 입력은 오늘/위젯 요약 API 구현 요청 분리 여부와 완료 변경 커밋 판단이다.
