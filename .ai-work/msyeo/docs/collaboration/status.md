...
| --- | --- | --- | --- | --- |
| PM | 완료 | REQ-20260428-25 | `.ai-work/msyeo/docs/`, 협업 문서 | 위젯/딥링크 1차 설계 완료 |
| QA | 완료 | REQ-20260428-24 | API 문서, 테스트 시나리오, `mobile-flutter/test` | REQ-02, REQ-06, REQ-10, REQ-24 완료 |
| FE 개발자 | 완료 | REQ-20260428-26 | `mobile-flutter/lib`, `mobile-flutter/test` | REQ-09 CRUD 구현 완료, REQ-26 사용성 개선 후보 설계 완료 |
| BE 개발자 | 대기 | REQ-20260428-22 | `src/main/java`, `src/test/java`, `src/main/resources` | 오류 계약 보강과 사용성 API 후보 설계 대기 |
...
2. BE: `REQ-20260428-27` 사용성 개선용 API 후보 설계
3. FE/QA: CRUD 감정 코드 입력을 감정 목록 선택 UI로 바꿀지 후속 UX 범위 판단
4. PM: `REQ-20260428-25`, `REQ-20260428-26` 결과를 FE 딥링크/캘린더 요청과 BE 위젯 요약 API 후보로 분리할 시점 판단
...
- 다음 PM 확인 입력은 BE `REQ-20260428-22`, BE `REQ-20260428-27` 진행 결과다.
