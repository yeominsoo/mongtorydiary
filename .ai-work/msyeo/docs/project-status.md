...
4. QA: `REQ-20260428-35` MVP 릴리스 회귀 체크리스트와 신규 개선 검증 계획 작성
5. PM: `REQ-20260428-40` 네이티브 위젯 shell 범위 결정
6. PM: 완료된 문서/설계 변경과 진행 중 코드 변경의 커밋 범위 분리
7. PM: `.ai-work/msyeo/docs/project-analysis.md`와 `delivery-roadmap.md`를 주요 구조 변경 시 함께 갱신
